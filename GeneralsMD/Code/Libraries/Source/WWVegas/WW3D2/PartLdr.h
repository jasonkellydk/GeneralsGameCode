 ...
 *                 Project Name : WW3D                                                         *
 *                                                                                             *
 *                     $Archive:: /Commando/Code/ww3d2/PartLdr.h          $*
 *                                                                                             *
...
class ParticleEmitterDefClass
{
	public:
		...
		//	Inline Accessors
		//
		int						Get_Render_Mode () const			{ return m_InfoV2.RenderMode; }	// values defined in W3DFile.h
		int						Get_Frame_Mode () const			{ return m_InfoV2.FrameMode; } // values in W3DFile.h
		...
		virtual void			Set_Render_Mode (int mode)						{ m_InfoV2.RenderMode = mode; } // values in W3DFile.h
		virtual void			Set_Frame_Mode (int mode)						{ m_InfoV2.FrameMode = mode; } // values in W3DFile.h
