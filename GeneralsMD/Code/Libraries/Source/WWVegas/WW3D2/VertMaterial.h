...
public:
	...
	*/
	...
	enum ColorSourceType {
		MATERIAL = 0,				// The color source should be taken from the material setting.
		COLOR1,						// The color should be taken from per-vertex color array 1.
		COLOR2,						// The color should be taken from per-vertex color array 2.
	};
	...
	*/
	...
	/*
	** UV source control.  The vertex format can support up to 8 uv-arrays.  The vertex
