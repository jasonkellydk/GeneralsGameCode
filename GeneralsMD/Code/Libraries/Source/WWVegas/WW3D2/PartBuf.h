 ...
 *                 Project Name : G                                        *
 *                                                                         *
 *                     $Archive:: /VSS_Sync/ww3d2/PartBuf.h              $*
 *                                                                         *
 *                      $Author:: Vss_sync                                $*
 *                                                                         *
...
class ParticleBufferClass : public RenderObjClass
{
	...
	protected:
		...
		int				RenderMode;		// rendering mode being used (settings found in W3DFile.h)
		int				FrameMode;		// frame mode (settings found in W3DFile.h - 1x1..16x16)
