 ...
 *                                                                                             *
 *                     $Archive:: /Commando/Code/ww3d2/dx9caps.h                              $*
 *                                                                                             *
...
public:
	...
	DX9Caps(IDirect3D9* direct3d, const D3DCAPS9& caps,WW3DFormat display_format, const D3DADAPTER_IDENTIFIER9& adapter_id);
	DX9Caps(IDirect3D9* direct3d, IDirect3DDevice9* D3DDevice,WW3DFormat display_format, const D3DADAPTER_IDENTIFIER9& adapter_id);
	...
	D3DCAPS9 const & Get_DX9_Caps() const { return Caps; }
