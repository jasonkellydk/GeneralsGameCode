 ...
 *                 Project Name : ww3d                                                         *
 *                                                                                             *
 *                     $Archive:: /Commando/Code/ww3d2/meshrendererdebugger.h                  $*
 *                                                                                             *
...
// Note! For the debugger to be usable, the application must call RendererDebuggerClass::Update() once
// each frame.

class RendererDebuggerClass
{
	static bool Enabled;
public:
