...
namespace Debug_Statistics
{
	...
	int Get_Polygons();
	int Get_Vertices();
	int Get_Skin_Renders();
	int Get_Skin_Polygons();
	int Get_Skin_Vertices();
...
#define RECORD_TEXTURE(t) Debug_Statistics::Record_Texture(t)
#define RECORD_TEXTURE_ARRAY(t,c) Debug_Statistics::Record_Texture_Array(t,c)
#define RECORD_RENDER(polys,verts,shader) Debug_Statistics::Record_Polys_And_Vertices(polys,verts,shader)
#define RECORD_SORTING_RENDER(polys,verts) Debug_Statistics::Record_Sorting_Polys_And_Vertices(polys,verts)
#define RECORD_SKIN_RENDER(polys,verts) Debug_Statistics::Record_Skin_Polys_And_Vertices(polys,verts)
