...
**                             SurfaceClass
**
** This is our surface class, which wraps an opaque render-backend surface.
**
...
class SurfaceClass : public RefCountClass
{
	...
	public:
		...
		// Create the surface from an opaque render-backend surface.
		SurfaceClass(RenderBackendSurface *surface);
		...
		// For use by the active render backend:
		RenderBackendSurface *Get_Render_Backend_Surface() const { return BackendSurface; }

		// Attaching and detaching a surface pointer
		void	Attach (RenderBackendSurface *surface);
		void	Detach (void);
	...
	private:
		...
		// Opaque surface owned by the active render backend.
		RenderBackendSurface *BackendSurface;
