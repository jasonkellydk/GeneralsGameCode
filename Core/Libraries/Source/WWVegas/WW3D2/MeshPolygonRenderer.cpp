 ...
 *                 Project Name : ww3d                                                         *
 *                                                                                             *
 *                     $Archive:: /Commando/Code/ww3d2/meshpolygonrenderer.cpp                 $*
 *                                                                                             *
...
MeshPolygonRendererClass::MeshPolygonRendererClass(
	...
	pass(pass_)
{
	...
	Get_Mesh_Model_Render_Data(mmc)->PolygonRendererList.Add_Tail(this);
}

MeshPolygonRendererClass::MeshPolygonRendererClass(const MeshPolygonRendererClass& src,MeshModelClass* mmc_)
	:
	mmc(mmc_),
...
void MeshPolygonRendererClass::Log()
{
