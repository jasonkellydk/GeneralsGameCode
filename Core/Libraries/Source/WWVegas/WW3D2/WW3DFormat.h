...
/*
** Enum for the surface formats understood by the renderer. This is a small
** portable subset of the formats supported by the active render backend.
**
** The format names retain the historical conventions:
**      A = Alpha
**      R = Red
**      G = Green
**      B = Blue
