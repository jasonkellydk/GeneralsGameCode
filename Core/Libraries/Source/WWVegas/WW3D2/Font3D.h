...
public:
	...
	*/
	...
	float	Char_U_Offset( wchar_t ch = (wchar_t)'H')		{ return UOffsetTable[ch&0xFF]; }// & 0xFF]; }
	float	Char_V_Offset( wchar_t ch = (wchar_t)'H')		{ return VOffsetTable[ch&0xFF]; }// & 0xFF]; }
	float	Char_U_Width( wchar_t ch = (wchar_t)'H' )		{ return UWidthTable[ch&0xFF]; }// & 0xFF]; }
	float	Char_V_Height( wchar_t /*ch = 'H'*/)			{ return VHeight; }
