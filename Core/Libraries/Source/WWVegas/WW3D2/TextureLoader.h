...
//		WW3DFormat texture_format);	// Pass WW3D_FORMAT_UNKNOWN if you don't care
	...
	// Returns true if the current thread may submit rendering work.
...
class TextureLoadTaskClass : public TextureLoadTaskListNodeClass
{
	public:
		...
		RenderBackendTextureHandle Peek_Render_Backend_Texture(void) { return BackendTexture; }
...
private:
	...
	RenderBackendTextureHandle Peek_Render_Backend_Cube_Texture(void) { return BackendTexture; }
...
private:
	...
	RenderBackendTextureHandle Peek_Render_Backend_Volume_Texture(void) { return BackendTexture; }
