 ...
 *                 Project Name : WW3D                                                         *
 *                                                                                             *
 *                     $Archive:: /Commando/Code/ww3d2/AggDef.h                              $*
 *                                                                                             *
...
class AggregateDefClass
{
	public:
		...
		void							Set_Name (const char *pname)			{ SAFE_FREE (m_pName); m_pName = WW3DString::Duplicate (pname); }
		...
		//	Public accessors
		//
		unsigned long							Class_ID () const					{ return m_MiscInfo.OriginalClassID; }
