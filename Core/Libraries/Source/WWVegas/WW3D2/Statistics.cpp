...
static int polygons;
static int last_frame_polygons;
static int vertices;
static int last_frame_vertices;
...
int Debug_Statistics::Get_Polygons()
{
	return last_frame_polygons;
}

int Debug_Statistics::Get_Vertices()
{
	return last_frame_vertices;
}
...
void Debug_Statistics::Begin_Statistics()
{
	...
	WW3D::Get_Render_Backend()->Begin_Backend_Statistics();
//	DX9MeshRendererClass::Begin_Backend_Statistics();
}
...
void Debug_Statistics::End_Statistics()
{
	...
	last_frame_polygons=polygons;
	last_frame_vertices=vertices;
	last_frame_sorting_polygons=sorting_polygons;
	last_frame_sorting_vertices=sorting_vertices;
	last_frame_draw_calls=draw_calls;
//	DX9MeshRendererClass::End_Backend_Statistics();
	WW3D::Get_Render_Backend()->End_Backend_Statistics();
}
